DigiCube 0.1.2
Copyright (c) 2014 DigiCube developers
...
About DigiCube
---------------
DigiCube is a DigiCube network-compatible, community-developed wallet client.

The project has been designed to provide people with a
stable, secure, and feature-rich alternative to the DigiCube reference
wallet (http://github.com/DigiCube/DigiCube). 

To help faciliate broad community cooperation, a number of trusted 
DigiCube/Peershares community leaders have write permissions to the project's 
...
Resources
---------
DigiCube source code: https://github.com/DigiCube/DigiCube

For the most current instructions covering how to compile DigiCube from 
source on a variety of operating systems, please visit:
https://github.com/DigiCube/DigiCube/tree/master/doc

Open software issues can be viewed, and new issues can be reported at:
https://github.com/DigiCube/DigiCube/issues?state=open

DigiCube discussion forums (hosted by DigiCubeTalk.org): 
http://www.DigiCubetalk.org/index.php?board=64.0



Acknowledgements
----------------
DigiCube owes it's existance to the time and effort put forth by
the developers and supporters of the following projects:


	DigiCube (DigiCube) 0.4.0 BETA
	Copyright (c) 2011-2014 Bitcoin Developers

	Distributed under the MIT/X11 software license
	(http://www.opensource.org/licenses/mit-license.php)

	DigiCube is a free open source project with the goal of providing a 
	...
	http://github.com/DigiCube/DigiCube
