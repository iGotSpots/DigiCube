...
// DigiCube message start (switch from Bitcoin's in v0.2)
static unsigned char pchMessageStartBitcoin[4] = { 0x1a, 0x1b, 0x1c, 0x1d };
static unsigned char pchMessageStartDigiCube[4] = { 0xba, 0xcb, 0xdc, 0xad };
...
void GetMessageStart(unsigned char pchMessageStart[], bool fPersistent)
{
    if (fTestNet)
        ...
        memcpy(pchMessageStart, (fPersistent || GetAdjustedTime() > nMessageStartSwitchTime)? pchMessageStartDigiCube : pchMessageStartBitcoin, sizeof(pchMessageStartDigiCube));
}
