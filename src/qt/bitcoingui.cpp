...
{
    resize(850, 550);
    setWindowTitle(tr("DigiCube Wallet"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/DigiCube_icon"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a DigiCube address"));
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
    tabGroup->addAction(sendCoinsAction);
	
    onthewebAction = new QAction(QIcon(":/icons/web"), tr("&Analytics"), this);
    ...
    aboutAction = new QAction(QIcon(":/icons/DigiCube_tooltip"), tr("&About DigiCube"), this);
    aboutAction->setToolTip(tr("Show information about DigiCube"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for DigiCube"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/DigiCube_tooltip"), tr("Show/Hide &DigiCube"), this);
    toggleHideAction->setToolTip(tr("Show or hide the DigiCube window"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        if(clientModel->isTestNet())
        {
            ...
            setWindowIcon(QIcon(":icons/DigiCube_icon"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/DigiCube_icon"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(title_testnet);
                trayIcon->setIcon(QIcon(":/icons/DigiCube_tooltip"));
            }
        }
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("DigiCube client"));
    trayIcon->setIcon(QIcon(":/icons/DigiCube_tooltip"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DigiCube network", "", count));
}
