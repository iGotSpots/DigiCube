...
#define CUBE_VERSION_MAJOR       2
#define CUBE_VERSION_MINOR       1
#define CUBE_VERSION_REVISION    0
#define CUBE_VERSION_BUILD       0

static const int CUBE_VERSION =
                           1000000 * CUBE_VERSION_MAJOR
                         +   10000 * CUBE_VERSION_MINOR
                         +     100 * CUBE_VERSION_REVISION
                         +       1 * CUBE_VERSION_BUILD;

// DigiCube version - reference for code tracking
