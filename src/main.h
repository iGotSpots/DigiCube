...
static const int LAST_POW_BLOCK = 1020000;
...
public:
    ...
    {
        // DigiCube: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // DigiCube: get transaction coin age
...
public:
    ...
    // DigiCube: block signature - signed by coin base txout[0]'s owner
    ...
    // DigiCube: two types of block: proof-of-work or proof-of-stake
    ...
    // DigiCube: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // DigiCube: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // DigiCube: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // DigiCube: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // DigiCube: block index flags
    enum  
    {
